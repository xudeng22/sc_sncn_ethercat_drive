        ...
        on tile[APP_TILE_2]:
        {
            par
            {
                /* Position Control Loop */
                {
                     ...
                     pos_velocity_ctrl_config.int9_P_position = POSITION_Kp;
                     pos_velocity_ctrl_config.int9_I_position = POSITION_Ki;
                     pos_velocity_ctrl_config.int9_D_position = POSITION_Kd;
