                       ...
                       interface ADCInterface client ?i_adc, chanend coe_out, chanend pdo_out, chanend pdo_in)
{
    ...
    while (1) {
        ...
        InOut.velocity_actual = i_tuning.get_velocity();
...
//                mode = c;
//        }
//        if (old_mode !=  InOut.operation_mode || old_value != InOut.target_position) {
//            mode = InOut.operation_mode;
//            value = sext(InOut.target_position, 32);
//            old_mode = mode;
//            old_value = InOut.target_position;
//            printf("mode %c, value %d\n", mode, value);
//        }
