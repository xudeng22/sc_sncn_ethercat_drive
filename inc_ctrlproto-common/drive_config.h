...
#define SHUTDOWN_CMD    (QUICK_STOP_CONTROL | ENABLE_VOLTAGE_CONTROL) & 0x7
#define SWITCH_ON_CMD   (QUICK_STOP_CONTROL | ENABLE_VOLTAGE_CONTROL | SWITCH_ON_CONTROL) & 0x7
#define DISABLE_VOLT_CMD    0 // ~(ENABLE_VOLTAGE_CONTROL)
#define QUICK_STOP_CMD  (ENABLE_VOLTAGE_CONTROL) & 0x7
