...
#define SHUTDOWN				0x0006 // x110
#define SWITCH_ON				0x000F // 1111
#define QUICK_STOP  			0x000B // 1011
#define CLEAR_FAULT 			0x0080 // 10000000
...
#define SHUTDOWN_CMD    (QUICK_STOP_CONTROL | ENABLE_VOLTAGE_CONTROL) & 0x7                     // 0110
#define SWITCH_ON_CMD   (QUICK_STOP_CONTROL | ENABLE_VOLTAGE_CONTROL | SWITCH_ON_CONTROL) & 0x7 // 0111
#define DISABLE_VOLT_CMD    0 // ~(ENABLE_VOLTAGE_CONTROL)
#define QUICK_STOP_CMD  (ENABLE_VOLTAGE_CONTROL) & 0x7                                          // 0010
#define DISABLE_OP_CMD  (QUICK_STOP_CONTROL | ENABLE_VOLTAGE_CONTROL | SWITCH_ON_CONTROL) & 0xf
#define ENABLE_OP_CMD   (ENABLE_OPERATION_CONTROL | QUICK_STOP_CONTROL | ENABLE_VOLTAGE_CONTROL | SWITCH_ON_CONTROL) & 0xf
