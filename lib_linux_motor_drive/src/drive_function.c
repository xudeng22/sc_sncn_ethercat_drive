...
{
	slv_handles[slave_number].profile_position_params.position_feedback_params.resolution = \
			slv_handles[slave_number].motor_config_param.s_position_encoder_resolution.position_encoder_resolution; //set qei resolution
	slv_handles[slave_number].profile_position_params.position_feedback_params.pole_pairs = slv_handles[slave_number].motor_config_param.s_pole_pair.pole_pair; //set pole pairs
