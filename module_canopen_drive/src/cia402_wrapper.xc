...
void print_object_dictionary(client interface i_co_communication i_co)
{
	...
	index = i_co.od_find_index(CIA402_MOTOR_SPECIFIC, 1);
	...
	index = i_co.od_find_index(COMMUTATION_OFFSET_CCLKWISE, 0);
    ...
    {sdo_value, void, void} = i_co.od_get_object_value(index);//Position Sensor Types HALL = 1, QEI_INDEX = 2, QEI_NO_INDEX = 3
    printstr("Position Sensor Types: ");printintln(sdo_value);
	index = i_co.od_find_index(CIA402_GEAR_RATIO, 0);
	...
	index = i_co.od_find_index(CIA402_SOFTWARE_POSITION_LIMIT, 1);
	...
	index = i_co.od_find_index(CIA402_SOFTWARE_POSITION_LIMIT, 2);
	...
	index = i_co.od_find_index(CIA402_MAX_PROFILE_VELOCITY, 0);
	...
	index = i_co.od_find_index(CIA402_PROFILE_DECELERATION, 0);
	...
	index = i_co.od_find_index(CIA402_QUICK_STOP_DECELERATION, 0);
	...
	index = i_co.od_find_index(CIA402_TORQUE_SLOPE, 0);
	...
	index = i_co.od_find_index(LIMIT_SWITCH_TYPE, 0);
	...
	index = i_co.od_find_index(CIA402_HOMING_METHOD, 0);
