...
{
	int sdo_value;
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MOTOR_SPECIFIC, 3); // Number of pole pairs
    printstr("Number of pole pairs: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MOTOR_SPECIFIC, 1); // Nominal Current
    printstr("Nominal Current: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MOTOR_SPECIFIC, 6);  //motor torque constant
    printstr("motor torque constant: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(COMMUTATION_OFFSET_CLKWISE, 0); //Commutation offset CLKWISE
    printstr("Commutation offset CLKWISE: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(COMMUTATION_OFFSET_CCLKWISE, 0); //Commutation offset CCLKWISE
    ...
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MOTOR_SPECIFIC, 4);//Max Speed
    printstr("Max Speed: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_SENSOR_SELECTION_CODE, 0);//Position Sensor Types HALL = 1, QEI_{index, error} =2, QEI_NO_{index, error} =3
    ...
    printstr("Sensor Polarity: ");printintln((signed short)sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MAX_TORQUE, 0);//MAX_TORQUE
    printstr("MAX TORQUE: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_SOFTWARE_POSITION_LIMIT, 1);//negative positioning limit
    printstr("negative positioning limit: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_SOFTWARE_POSITION_LIMIT, 2);//positive positioning limit
    printstr("positive positioning limit: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_POLARITY, 0);//motor driving polarity
    printstr("motor driving polarity: ");printintln(sdo_value);  // -1 in 2'complement 255
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MAX_PROFILE_VELOCITY, 0);//MAX PROFILE VELOCITY
    printstr("MAX PROFILE VELOCITY: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_PROFILE_VELOCITY, 0);//PROFILE VELOCITY
    printstr("PROFILE VELOCITY: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_MAX_ACCELERATION, 0);//MAX ACCELERATION
    printstr("MAX ACCELERATION: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_PROFILE_ACCELERATION, 0);//PROFILE ACCELERATION
    printstr("PROFILE ACCELERATION: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_PROFILE_DECELERATION, 0);//PROFILE DECELERATION
    printstr("PROFILE DECELERATION: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_QUICK_STOP_DECELERATION, 0);//QUICK STOP DECELERATION
    ...
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_POSITION_GAIN, 1);//Position P-Gain
    printstr("Position P-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_POSITION_GAIN, 2);//Position I-Gain
    printstr("Position I-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_POSITION_GAIN, 3);//Position D-Gain
    printstr("Position D-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_VELOCITY_GAIN, 1);//Velocity P-Gain
    printstr("Velocity P-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_VELOCITY_GAIN, 2);//Velocity I-Gain
    printstr("Velocity I-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_VELOCITY_GAIN, 3);//Velocity D-Gain
    printstr("Velocity D-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_CURRENT_GAIN, 1);//Current P-Gain
    printstr("Current P-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_CURRENT_GAIN, 2);//Current I-Gain
    printstr("Current I-Gain: ");printintln(sdo_value);
    {sdo_value, void, void} = i_co.od_get_object_value(CIA402_CURRENT_GAIN, 3);//Current D-Gain
...
{int, int, int, int, int} pv_sdo_update(client interface i_co_communication i_co)
{
    ...
    {profile_deceleration, void, void} = i_co.od_get_object_value(CIA402_PROFILE_DECELERATION, 0);
    {quick_stop_deceleration, void, void} = i_co.od_get_object_value(CIA402_QUICK_STOP_DECELERATION, 0);
...
{int, int, int} cst_sdo_update(client interface i_co_communication i_co)
{
    ...
    {polarity, void, void} = i_co.od_get_object_value(CIA402_POLARITY, 0);
    {max_torque, void, void} = i_co.od_get_object_value(CIA402_MAX_TORQUE, 0);
...
{int, int, int} csv_sdo_update(client interface i_co_communication i_co)
{
    ...
    {max_motor_speed, void, void} = i_co.od_get_object_value(CIA402_MOTOR_SPECIFIC, 4);
    {polarity, void, void} = i_co.od_get_object_value(CIA402_POLARITY, 0);
    {max_acceleration, void, void} = i_co.od_get_object_value(CIA402_MAX_ACCELERATION, 0);
...
{int, int, int, int, int} csp_sdo_update(client interface i_co_communication i_co)
{
    ...
    {max_motor_speed, void, void} = i_co.od_get_object_value(CIA402_MOTOR_SPECIFIC, 4);
    {polarity, void, void} = i_co.od_get_object_value(CIA402_POLARITY, 0);
    {min, void, void} = i_co.od_get_object_value(CIA402_SOFTWARE_POSITION_LIMIT, 1);
    {max, void, void} = i_co.od_get_object_value(CIA402_SOFTWARE_POSITION_LIMIT, 2);
    {max_acc, void, void} = i_co.od_get_object_value(CIA402_MAX_ACCELERATION, 0);
